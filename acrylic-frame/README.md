...
| C — top | 3 mm clear | 250 × 180 mm | two KA7_UNO CAN boards on M3 × 10 standoffs |
...
| C | two KETI KA7_UNO CAN boards, terminals facing out to either rim. **M3 × 10 standoffs**, not 8: each carrier has an ALINX AC7200 FPGA module plugged into its underside, hanging 7.22 mm down, so 8 mm left 0.78 mm and 10 leaves 2.78. Go to 20 if a heatsink goes on the FPGA |
| D | plain guard |
...
* **Plate C** — two KA7_UNO CAN boards at 63 × 83 each, fitted mirror-image so
  both boards' terminals face out to a rim. They stand on **M3 × 10** standoffs
