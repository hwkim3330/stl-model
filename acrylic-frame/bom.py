...
BOM = [
    ...
    ('hardware', 'Screw, pan head', 'M2.5 x 6 mm', 4, 'RS 528-716', 'RS Korea',
     'T-ETH-Elite down onto its standoffs'),
    ('hardware', 'Screw, pan head', 'M2.5 x 10 mm', 4, 'RS 797-6190', 'RS Korea',
    ...
    ('hardware', 'Washer, nylon', 'M3', 20, 'Essentra MFW030A / DK RPC1552-ND',
     'DigiKey Korea', 'under every screw head that lands on acrylic'),
