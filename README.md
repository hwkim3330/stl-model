...
**<https://hwkim3330.github.io/stl-model/>** — the frame, three candidate
rearrangements of it, the exploded stack, the CAN board, its printed case and
the LAN9692, spinnable in a browser. It is one self-contained HTML
...
Reading its Gerber properly turned up the thing that matters mechanically: the
four 80-pin board-to-board strips are on the **solder** side, so it is a
...
cd ../ka7-uno-can-board && python3 ka7_mock.py && python3 case.py
